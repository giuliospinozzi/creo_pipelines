...
# Pool name.
POOL_NAME="RNA-Seq_OPBG_Vinci_v2";
...
COMPARISONS="SL-NS-SU_VS_SL-AD,SL-IN_VS_SL-AD,SL-IN_VS_SL-NS-SU,FBS-NS-SU_VS_FBS-AD,FBS-IN_VS_FBS-AD,FBS-IN_VS_FBS-NS-SU";
