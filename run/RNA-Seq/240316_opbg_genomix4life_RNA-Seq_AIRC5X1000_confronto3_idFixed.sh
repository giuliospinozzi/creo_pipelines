...
# Pool name.
POOL_NAME="RNA-Seq_AIRC5X1000_comparison3_id_fixed";

# Sample names (',' sep).
SAMPLE_NAMES="MIG1,MIG2,MIG3,MIG4,MIG5,MIG6,MIG7,MIG8,MIG9,MIG10";
...
TYPE="Bulk,Bulk,Mig,Mig,Mig,Mig,Mig,Mig,Mig,Mig"
