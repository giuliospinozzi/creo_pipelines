...
macs2 callpeak -B -g hs -c /opt/ngs/results_tiacci/Chip-Tasselli/LT67/bam/INPUT-STAT6-D419N-ReplA/6_R1.sorted.filtered.bam /opt/ngs/results_tiacci/Chip-Tasselli/LT67/bam/INPUT-STAT6-D419N-ReplB/20_R1.sorted.filtered.bam -c /opt/ngs/results_tiacci/Chip-Tasselli/LT67/bam/STAT6-D419N-ReplA/13_R1.sorted.filtered.bam /opt/ngs/results_tiacci/Chip-Tasselli/LT67/bam/STAT6-D419N-ReplB/27_R1.sorted.filtered.bam -f BAMPE -n INPUT-STAT6-D419N --outdir /opt/ngs/results_tiacci/Chip-Tasselli/LT67/peaks/combinations/merged
