...
macs2 callpeak --pvalue 0.0001 -B -g hs -t /opt/ngs/results_tiacci/Chip-Tasselli/L1236/bam/L1236-E-R2-NT-pSTAT6a/E-R2-NT-pSTAT6a_L1_1.sorted.filtered.bam -c /opt/ngs/results_tiacci/Chip-Tasselli/L1236/bam/L1236-Rep2-NT-INPUTa/Clean_L1236_R2_NT_INPUTa_1.sorted.filtered.bam -f BAMPE -n NT-STAT6a-INPUTa-R2-INP-new --outdir /opt/ngs/results_tiacci/Chip-Tasselli/L1236/peaks/combinations/unfiltered
macs2 callpeak --pvalue 0.0001 -B -g hs -t /opt/ngs/results_tiacci/Chip-Tasselli/L1236/bam/L1236-G-R2-KO-pSTAT6b/G-R2-KO-pSTAT6b_L1_1.sorted.filtered.bam -c /opt/ngs/results_tiacci/Chip-Tasselli/L1236/bam/L1236-F-R2-KO-INPUTb/F-R2-KO-INPUTb_L1_1.sorted.filtered.bam -f BAMPE -n NT-pSTAT6b-INPUTb-R2-INP-new --outdir /opt/ngs/results_tiacci/Chip-Tasselli/L1236/peaks/combinations/unfiltered
...
closest-features --closest NT-STAT6a-INPUTa-R2-INP-new_summits.bed <(gtf2bed < /opt/genome/human/hg19/annotation/hg19.refgene.sorted.gtf) > NT-STAT6a-INPUTa-R2-INP-new_summits.annotated.bed
closest-features --closest NT-pSTAT6b-INPUTb-R2-INP-new_summits.bed <(gtf2bed < /opt/genome/human/hg19/annotation/hg19.refgene.sorted.gtf) > NT-pSTAT6b-INPUTb-R2-INP-new_summits.annotated.bed
