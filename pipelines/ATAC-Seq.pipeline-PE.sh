...
##### ================= ATAC Adapter Removal =================== #####
ADAPTER="CTGTCTCTTATACACATCT"
cutadapt -a "${ADAPTER}" -A "${ADAPTER}" -j ${MAXTHREADS} -o ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/fastq/${LIBRARY_NAME}/${BNAME_R1}_noAdapter.fastq.gz -p ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/fastq/${LIBRARY_NAME}/${BNAME_R2}_noAdapter.fastq.gz ${R1_FASTQ} ${R2_FASTQ}
rm ${R1_FASTQ} ${R2_FASTQ}
R1_FASTQ="${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/fastq/${LIBRARY_NAME}/${BNAME_R1}_noAdapter.fastq.gz";
R2_FASTQ="${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/fastq/${LIBRARY_NAME}/${BNAME_R2}_noAdapter.fastq.gz";
##### ========================================================== #####
