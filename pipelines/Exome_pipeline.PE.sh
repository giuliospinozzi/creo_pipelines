...
mkdir ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants
mkdir ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}
...
# Indel variants
printf "<`date +'%Y-%m-%d %H:%M:%S'`> ####### Variant Calling: Indel calling #######\n"
varscan mpileup2indel ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.mpileup > ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.indel
# Filtering Variants
printf "<`date +'%Y-%m-%d %H:%M:%S'`> ####### Variant Calling: Filtering #######\n"
varscan filter ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.snp –-indel-file ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.indel –- output-file ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.snp.filter
varscan filter ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.indel –-output-file ${RESULTS_DIR}/${PROJECT_NAME}/${POOL_NAME}/variants/${LIBRARY_NAME}/${BNAME_R1}.VarScan.indel.filter
